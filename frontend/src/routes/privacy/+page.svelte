...
<div class="min-h-screen bg-muted/25 text-foreground">
	<div class="mx-auto max-w-6xl px-6 sm:px-8 lg:px-10">
		...
		<main class="py-12 sm:py-16">
			<article class="mx-auto max-w-3xl rounded-none bg-background px-4 py-10 sm:px-10 sm:py-12">
				<header>
					...
					<p class="mt-3 text-sm text-muted-foreground">Last updated {lastUpdated}</p>
				</header>
				...
				>
					...
					<ul>
						<li>
							<strong>Account data</strong> — name, email, password hash, department or organization affiliation,
							and role.
						</li>
						<li>
							<strong>Training content</strong> — scenarios, scenes, and session events you create, along
							with assignments, transcripts, and decisions recorded during scenarios.
						</li>
						<li>
							<strong>Voice audio</strong> — radio audio captured during Command sessions for transcription
							and parsing. Do not upload recordings that must remain confidential under law or department
							policy without authorization.
						</li>
						<li>
							<strong>Billing data</strong> — name, billing address, and payment details handled by Stripe.
							We do not store full card numbers on our servers.
						</li>
						<li>
							<strong>Usage data</strong> — log data, device and browser information, pages visited, and
							errors, to operate and improve the service.
						</li>
					</ul>
					...
					<ul>
						<li>
							Run training scenarios and sessions, including real-time radio transcription and
							parsing.
						</li>
						<li>
							Let instructors and learners review decisions, transcripts, and audio after a session.
						</li>
						<li>Operate accounts, process payments, and provide support.</li>
						<li>Monitor performance, prevent abuse, and improve the product.</li>
						<li>
							Send transactional emails (for example, account verification or billing receipts).
						</li>
					</ul>

					<h2>Third-party services</h2>
					<p>We use third-party vendors to operate the service. These include:</p>
					<ul>
						<li>Hosting and infrastructure providers.</li>
						<li>
							Speech-to-text and language-model providers used for radio transcription and parsing.
						</li>
					...
					<p>
						We select vendors who offer reasonable security and privacy commitments. Voice audio
						used for transcription may be processed briefly by these providers to return a
						transcript.
					</p>

					<h2>Data retention</h2>
					<p>
						We retain account data for as long as your account is active. Training content
						(scenarios, session events, transcripts, and audio) is retained so you can review past
						sessions. You can delete specific content from within the app. When you delete your
						account, we delete or anonymize associated data within a reasonable period, subject to
						legal or accounting retention requirements.
					</p>

					<h2>Security</h2>
					<p>
						We use encryption in transit, access controls, and standard operational safeguards. No
						system is perfectly secure, and we encourage you to use strong passwords and not to
						upload confidential or legally protected recordings without authorization.
					</p>
					...
					<p>
						We may update this policy. When we make material changes, we will update the "last
