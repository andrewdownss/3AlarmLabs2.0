...
import { globalLimiter, radioLimiter } from './middleware/rate-limit.js';
...
app.use('/api/trainer', globalLimiter);
...
app.use('/api/trainer/radio', requireAuth, radioLimiter, createRadioRouter(io));
