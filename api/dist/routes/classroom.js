...
import { classroomParticipants, classrooms, organizationMembers, organizations, trainerSessions } from '../db/schema/trainer.js';
...
function isJoinRateLimited(key, now = Date.now()) {
